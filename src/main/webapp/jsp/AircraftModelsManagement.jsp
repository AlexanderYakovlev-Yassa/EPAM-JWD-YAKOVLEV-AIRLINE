				...
				<div class="row">
					...
					<div class="col-8 card border-primary">
						...
						<div class="overflow-auto" style="heigth: 200px">
							...
							<c:forEach var="elem" items="${sessionScope.all_aircraft_models_list}">								
								
								<tr onclick="airlineModelTabClick('current-aircraft-model-id', '${elem.aircraftModelID}',
															'current-aircraft-model-name', '${elem.aircraftModelName}',
															'current-aircraft-model-capacity', '${elem.aircraftModelCapacity}'
															)">
									<td>${elem.aircraftModelName}</td>	
									<td>${elem.aircraftModelCapacity}</td>
								</tr>		
										...
										<div class="card-body"> 
											...
											<input type="hidden" id="current-aircraft-model-id"
 											...
 											<div class="form-group">
												...
												<input type="text" name="aircraft_model_name"
													id="current-aircraft-model-name"
											...
											<div class="form-group">
												...
												<input type="text" name="aircraft_model_capacity"
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<button type="submit" class="btn btn-outline-primary"
											name="command" value="add_aircraft_model">
											<fmt:message key="button.add" />
										</button>
										<button type="submit" class="btn btn-outline-primary"
											name="command" value="update_aircraft_model">
											<fmt:message key="button.update" />
										</button>										
										<button type="submit" class="btn btn-outline-primary"
											name="command" value="delete_aircraft_model">
