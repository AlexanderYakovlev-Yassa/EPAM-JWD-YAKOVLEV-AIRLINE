...
public enum StringConstant {
    ...
    FLIGHTS_FOR_SELECTED_EMPLOYEE ("flights_for_selected_employee"),
    GUEST("guest"),
    ...
    PAGE_KEY ("page"),
    SECOND_SELECTED_DATE ("second_selected_date"),
    SECOND_DATE_KEY ("second_date"),
    SELECTED_FLIGHT_KEY ("selected_flight"),
    SELECTED_FLIGHTS_TIME_PERIOD_KEY ("selected_flights_time_period"),
